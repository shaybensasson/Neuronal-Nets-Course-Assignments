...
disp('============================================================')
%y1 = rectpuls(t,0.05);
d = -0.8 : 1/3 : 0.8;           % 3 Hz repetition frequency
y1 = pulstran(t,d,'rectpuls',0.05);

%y2 = tripuls(t,0.5,-1);
y2 = gauspuls(t,0.5,20);
...
for i = 1:iteration
    ...
    subplot(4,2,5:6)
    hold off
    plot(iterationSteps(1:i),crossCorrelation(1:i),'Color','black','LineWidth',2); axis([1 iteration -100 500]);
    xlabel('t')
...
for i = 1:iteration
    ...
    subplot(4,2,7:8)
    hold off
    plot(iterationSteps(1:i),convolution(1:i),'Color','black','LineWidth',2); axis([1 iteration -100 500]);
    xlabel('t')
    %ylabel('(y1 * y2)(t) ')
