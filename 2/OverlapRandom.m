...
TotalCells = 400;
NumPatt = 20; %Number of memory patterns that network will attempt to store and retrieve
N = round(TotalCells/NumPatt); %Number of neurons in the network (and number of elements in a memory pattern)
